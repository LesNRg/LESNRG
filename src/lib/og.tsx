    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          <svg width="104" height="104" viewBox="8.511 8.511 82.977 82.977">
            <circle cx="50" cy="50" r="31.72" fill="white" />
            <path d={FAN_SQUARE} fill="#F5C500" fillRule="evenodd" />
            <path d={FAN_BLADES} fill="#F5C500" />
          </svg>
          <div
            style={{
              width: 2,
        ...
        {/* Yellow rule */}
        <div style={{ display: "flex", height: 10, backgroundColor: "#F5C500" }} />
      </div>
    ),
    {
      ...size,
      fonts: [
        { name: "Inter", data: inter, style: "normal", weight: 800 },
        { name: "Peddana", data: peddana, style: "normal", weight: 400 },
      ],
    }
  );
}
