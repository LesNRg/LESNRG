...
const companyServices = [
  ...
  { title: "Large Building Testing", desc: "Multi-fan blower door testing for commercial and industrial facilities. ASTM E779 and E3158 compliant." },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "About", item: "https://www.lesnrg.com/about" },
  ],
};
